...
(function () {
  ...
  class ChatWidget {
    ...
    createWidget() {
      ...
      const initialIcon = this.config.auto_open && !this.config.centered && !this.config.stay_open ? icons.close : icons.chat;
      const widgetHTML = `
                <div class="chat-widget-popup" id="chat-widget">
                    ...
                    ${this.config.suggestions.length ? `
                        ...
                        <div class="chat-suggestions">
                            ${this.config.suggestions.map(suggestion => `<button class="chat-suggestion">${suggestion}</button>`).join('')}
                        </div>
                    ` : ''}
